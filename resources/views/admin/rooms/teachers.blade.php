...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title text-bold" style="font-size:1.4rem">Room Teachers</h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.rooms.teachers.store', $room->id) }}" method="post">
                @csrf @method('PUT')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Delete Form -->
                            <form id="delete-form-{{ $teacher->id }}" action="{{ route('admin.rooms.teachers.remove', $teacher->id) }}" method="post">
